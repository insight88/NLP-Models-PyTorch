...
def get_parse_args() -> (argparse, object, object, object):
    ...
    parser.add_argument("--config_file", default='models/seq_seq_config.json', type=str, help="")
    ...
    parser.add_argument("--max_steps_per_epoch", default=2000, type=int,
    ...
    return parser.parse_args(), Transformer, Config, LMDataset
...
def train(
    ...
    if rank == 0:
        ...
        model_params_encoder = count_parameters(model.module.encoder) + count_parameters(model.module.decoder)
...
ARGS, Transformer, Config, LMDataset = get_parse_args()
