...
def get_parse_args() -> (argparse, object, object, object):
    ...
    model = 'mix_LM' # 'mix_LM', 'transformer', 'gMLP'
    task = 'ICT'  # 'ICT', 'SOP'
...
def train(
    ...
    if rank == 0:
        ...
        LOGGER.info("FP16 Enable : %s, auto_wrap Enable : %s, Zero3 Enable : %s,", args.fp16, args.auto_wrap, args.zero3)
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.save_steps > 0 and global_step % args.save_steps == 0:
                    ...
                    if rank == 0:
                        torch.save(model_state_dict, model_checkpoint)
