...
#from models.mix_LM import Config, BertMultiTask_SOP as BertMultiTask
#from models.gMLP import Config, BertMultiTask_ICT as BertMultiTask
#from models.gMLP import Config, BertMultiTask_SOP as BertMultiTask
#from models.transformer import Config, BertMultiTask_ICT as BertMultiTask
#from models.transformer import Config, BertMultiTask_SOP as BertMultiTask
...
def main():
    ...
    parser.add_argument("--config_file", default='models/mix_LM_config.json', type=str, 
                        help="모델 설정 파일 지정")
    #parser.add_argument("--config_file", default='models/gMLP_config.json', type=str, 
    #                    help="모델 설정 파일 지정")
    #parser.add_argument("--config_file", default='models/transformer_config.json', type=str, 
    #                    help="모델 설정 파일 지정")
    ...
    model_params_encoder = count_parameters(model.bert.encoder)
